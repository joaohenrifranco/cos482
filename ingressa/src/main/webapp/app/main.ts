...
import MovieTicketProcessService from '@/entities/movie-ticket-process/movie-ticket-process.service';
...
new Vue({
  ...
  provide: {
    ...
    movieTicketProcessService: () => new MovieTicketProcessService(),
