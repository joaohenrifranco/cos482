  ...
  <div class="row justify-content-center">
    <div class="col-8">
      <form name="editForm" role="form" novalidate v-on:submit.prevent="save()">
        <h2
          id="ingressaApp.processDefinition.home.createOrEditLabel"
          data-cy="ProcessDefinitionCreateUpdateHeading"
          v-text="$t('ingressaApp.processDefinition.home.createOrEditLabel')"
        >
        ...
        <div>
          ...
          <div class="form-group" v-if="processDefinition.id">
            <label class="form-control-label" v-text="$t('ingressaApp.processDefinition.name')" for="process-definition-name">Name</label>
            <input type="text" class="form-control" name="name" id="process-definition-name" v-model="processDefinition.name" readonly />
          </div>
          <div class="form-group">
            <label
              class="form-control-label"
              v-text="$t('ingressaApp.processDefinition.specificationFile')"
