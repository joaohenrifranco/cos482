      ...
      <div class="xcontainer">
        <div class="row px-3">
          ...
          <div class="col summary">
            <div class="label" v-text="$t('ingressaApp.processDefinition.status')">Status</div>
            ...
            <hr />
            <div class="label" v-text="$t('ingressaApp.processDefinition.camundaDeploymentId')">Camunda Deployment Id</div>
            <div class="link" v-if="processDefinition.camundaDeploymentId">
              {{ processDefinition.camundaDeploymentId }}
            </div>
            <hr />
            <div class="label" v-text="$t('ingressaApp.processDefinition.camundaProcessDefinitionId')">Camunda Process Definition Id</div>
