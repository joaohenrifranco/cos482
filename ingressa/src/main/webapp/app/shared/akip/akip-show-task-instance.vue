      ...
      <div class="xcontainer">
        <div class="row px-3">
          ...
          <div class="col summary">
            <div class="label" v-text="$t('ingressaApp.taskInstance.assignee')">Assignee</div>
            <div class="link" v-if="taskInstance.assignee">
              {{ taskInstance.assignee }}
            </div>
            <div class="link" v-else>Unassigned</div>
            <hr />
            <div class="label" v-text="$t('ingressaApp.taskInstance.processDefinition')">Process Definition</div>
            ...
            <hr />
            <div class="label" v-text="$t('ingressaApp.taskInstance.processInstance')">Process Instance</div>
            ...
            <hr />
            <div class="label" v-text="$t('ingressaApp.taskInstance.taskDefinitionKey')">Task Definition Key</div>
            <div v-if="taskInstance.taskDefinitionKey">
              {{ taskInstance.taskDefinitionKey }}
            </div>
            <hr />
            <div class="label" v-text="$t('ingressaApp.taskInstance.taskId')">Task Id</div>
            <div v-if="taskInstance.taskId">
              {{ taskInstance.taskId }}
            </div>
            <hr />
            <div class="label" v-text="$t('ingressaApp.taskInstance.executionId')">Execution Id</div>
