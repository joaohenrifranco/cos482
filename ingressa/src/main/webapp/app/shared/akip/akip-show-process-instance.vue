      ...
      <div class="xcontainer">
        <div class="row px-3">
          <div class="col-9 description">
            <slot name="details">
              <div class="form-group">
                <label class="form-control-label" v-text="$t('ingressaApp.processInstance.businessKey')" for="process-instance-business-key"
                  >Business Key</label
                >
                <input
                  readonly
          ...
          <div class="col summary">
            <div class="label" v-text="$t('ingressaApp.processInstance.status')">Status</div>
            ...
            <hr />
            <div class="label" v-text="$t('ingressaApp.processInstance.processDefinition')">Process Definition</div>
            ...
            <hr />
            <div class="label" v-text="$t('ingressaApp.processInstance.camundaProcessInstanceId')">Camunda Process Instance Id</div>
            <div class="link" v-if="processInstance.camundaProcessInstanceId">
              {{ processInstance.camundaProcessInstanceId }}
            </div>
            <hr />
            <div class="label" v-text="$t('ingressaApp.processInstance.camundaProcessDefinitionId')">Camunda Process Definition Id</div>
            <div class="link" v-if="processInstance.camundaProcessDefinitionId">
              {{ processInstance.camundaProcessDefinitionId }}
            </div>
            <div class="link" v-if="processInstance.processDefinition">
              <hr />
              <div class="label" v-text="$t('ingressaApp.processDefinition.bpmnProcessDefinitionId')">BPMN Process Definition Id</div>
